...
You can find the code for the meta-analysis at UKB_AllofUS Meta-analysis.md in this github.
The analysis results in PheWEB like web server can be found at 
